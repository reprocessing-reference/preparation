...
public class ODataProxyProcessor {
    ...
    private void unproxyElements(Object entity, Set<Object> visitedEntities, List<String> expandProperties)
        ...
        for (Field field : fields) {
            ...
            LOG.debug("Unproxying field : "+field.getName());
            try {
                ...
                if (isJPAEntity(fieldType)) {
                	...
                	LOG.debug("Persistent collection detected");
                    ...
                    if (collection.wasInitialized()) {
                    	...
                    	LOG.debug(Boolean.toString(!sourceEntity));
                    	LOG.debug(Boolean.toString(!isEntityExpanded(entity, expandProperties)));                    	
