...
public class ProductDataSource implements DataSource {
    ...
    private ConcurrentMap<UUID, Product> personConcurrentMap = new ConcurrentHashMap<>();
    ...
    public void delete(ODataUri oDataUri, EntityDataModel entityDataModel) throws ODataException {
        ...
        if(entity.isDefined()) {
        	Product person = (Product) entity.get();
    ...
    public ConcurrentMap<UUID, Product> getPersonConcurrentMap() {
