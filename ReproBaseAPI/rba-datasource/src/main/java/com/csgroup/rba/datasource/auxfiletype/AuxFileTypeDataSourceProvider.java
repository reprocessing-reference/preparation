 ...
 */
@Component
public class AuxFileTypeDataSourceProvider implements DataSourceProvider {
    private static final Logger LOG = LoggerFactory.getLogger(AuxFileTypeDataSourceProvider.class);

    @Autowired
    private AuxFileTypeDataSource inDataSource;
    ...
    public QueryOperationStrategy getStrategy(ODataRequestContext oDataRequestContext, QueryOperation queryOperation, TargetType targetType) throws ODataException {
        ...
        return () -> {
            ...
            if (propertyNames != null && !propertyNames.isEmpty()) {
                try {
                    LOG.debug("Selecting {} properties of auxfiletype", propertyNames);
