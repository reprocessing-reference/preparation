 ...
 * @author besquis
 */
@EdmFunctionImport(function = "GetReproBaselineListForPeriodUnBound", includeInServiceDocument = true,
name = "GetReproBaselineListForPeriod", namespace = "OData.RBA")
public class GetReproBaselineForPeriodImport {
	private static final Logger LOG = LoggerFactory.getLogger(GetReproBaselineForPeriodImport.class);
