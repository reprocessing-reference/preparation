...
public class AuxipAccess {
	...
	public List<String> getListOfAuxFileURLs(final List<AuxFile> files, String bearerToken) throws Exception{
		...
		for (AuxFile f : files) {
			String post = httpHandler.getPost(config.getAuxip_url()+
					"/Products?$filter=contains(Name,'"+f.FullName.trim()+"\')",null);
			JsonNode actualObj;
			try {
				actualObj = mapper.readTree(post.replaceAll("@", ""));
			...
			if (valueNode.isArray()) {
				...
				for (JsonNode value : valueNode) {
					/*
					 ...
					 "value":[{"@odata.mediaContentType":"text/plain","ID":"ffc183a9-7555-4427-b246-176e2485abed",
					 "Name":"S2B_OPER_GIP_G2PARA_MPC__20170206T103032_V20170101T000000_21000101T000000_B00.TGZ",
					 "ContentType":"application/octet-stream","ContentLength":3039,
					 "OriginDate":"2017-02-06T09:30:32Z","PublicationDate":"2021-03-12T10:26:33.658341Z",
					 "EvictionDate":"2123-08-27T09:26:33.658323Z",
